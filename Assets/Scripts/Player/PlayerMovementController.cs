...
public class PlayerMovementController : MonoBehaviour, IMovementController {
    ...
    // events
    public EventHandler<LandEventArgs> LandEvent;
    ...
    protected virtual void RaiseLandEvent(LandEventArgs e) {
        EventHandler<LandEventArgs> raiseEvent = LandEvent;
    ...
    public void Jump(Numpad direction) {
        ...
        // playerState.canAct && !attackController.isAttacking && 
        !inHitStop && AirActionsLeft == MaxAirActions;
        bool canDoubleJump = !isGrounded && 
        // playerState.canAct && 
        // !attackController.isAttacking && 
        !inHitStop && AirActionsLeft > 0;
